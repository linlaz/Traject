@extends('layouts.app')
@section('title', 'Traject | Package Details')
@section('style')
            ...
            <div class="row">
                <div class="col-lg-8 my-1">
                    <div class="card card-details">
                        <h1>{{ $item->title }}</h1>
                        <p>{{ $item->location }}</p>
                        @if ($item->galleries_hotel->count())
                            <div class="gallery">
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ url($item->galleries_hotel->first()->image) }}" class="d-block w-100" alt="...">
                                        </div>
                                        @foreach ($item->galleries_hotel as $gallery)
