    ...
    <main>
        ...
        <div class="container package-content">
            <div class="package-search my-1">
                ...
                <form action="{{ route('service-hotel') }}" method="GET" role="search">
            ...
            <div class="my-5">
                ...
                <section class="section-popular-content">
                    <div class="section-popular-travel row justify-content-center">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="card-travel text-center d-flex flex-column py-5"
                            style="background-image: url('{{ $popular->galleries_hotel->count() ? url ($popular -> galleries_hotel -> first() -> image) : '' }}');">
                                <div class="travel-country">{{ $popular->location }}</div>
                                <div class="travel-location">{{ $popular->title }}</div>
                                <div class="travel-button">
                                    <a href="{{ route('hotel-detail', $popular->id)}}" class="btn btn-travel-details px-4">View Details</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
