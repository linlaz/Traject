                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071C4D;">
                        Hi, {{$data->user->name}} <br><br> Tiket digital kamu sudah berhasil dicetak. <br> Booking ID <strong>#{{$data->id}}</strong>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    {{-- <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                        <tr>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071C4D;font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td colspan="3">Hotel Details</td>
                        </tr>
                        <tr>
                          <td><strong>Nama Hotel</strong>
                          <td style="text-align: right;">{{$data->hotel->title}}</td>
                        </tr>
                        <tr>
                          <td><strong>Start Date</strong>
                          <td style="text-align: right;">{{$data->start_date}}</td>
                        </tr>
                        <tr>
                            <td><strong>Finish Date</strong>
                            <td style="text-align: right;">{{ $data->finish_date }}</td>
                          </tr>
                      </table>
                    </td>
                  </tr>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tr>
                          <td align="center" bgcolor="#FF9E53" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#FF9E53;" valign="middle">
                            <a href="{{ url('/detail/detail-checkout-hotel/'. $data->id) }}" style="display:inline-block;background:#FF9E53;color:#FFFFFF;font-family:Assistan, Halvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Check Detail </a>
                          </td>
                        </tr>
                      </table>
                    </td>
            ...
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0px;text-align:center;">
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Halvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071C4D;">Need Help?</div>
                    </td>
                  </tr>
                </table>
              </div>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        ...
                        font-family: Assistant, Halvetica, Arial, sans-serif"> support@traject.com <br> 0895708134567 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Halvetica, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#888B93;">2020 traject Copyright All Right Reserved.</div>
                    </td>
                  </tr>
                </table>
              </div>
